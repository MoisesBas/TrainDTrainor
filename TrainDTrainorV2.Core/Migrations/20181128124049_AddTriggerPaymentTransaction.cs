...
{
    public partial class AddTriggerPaymentTransaction : Migration
    {
        private string TableName => "tbl" + typeof(PaymentTransaction).Name + "s";
        private string FileTableName => typeof(TrainDTrainorV2.Core.Data.Entities.PaymentTransactionPic).Name;
