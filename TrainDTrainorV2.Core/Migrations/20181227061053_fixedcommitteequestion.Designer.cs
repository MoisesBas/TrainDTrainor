...
namespace TrainDTrainorV2.Core.Migrations
{
    ...
    [Migration("20181227061053_fixedcommitteequestion")]
    partial class fixedcommitteequestion
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TrainDTrainorV2.Core.Data.Entities.CommitteeQuestion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Id")
                    ...
                    b.ToTable("tblCommitteeQuestions","dbo");
                });

            modelBuilder.Entity("TrainDTrainorV2.Core.Data.Entities.CommitteeQuestionEvaluation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Id")
                    ...
                    b.Property<Guid?>("BuildCourseAttendeeId")
                        .IsRequired()
                    ...
                    b.Property<Guid?>("CommitteeQuestionId")
                        .IsRequired()
                    ...
                    b.HasIndex("BuildCourseAttendeeId");

                    b.HasIndex("CommitteeQuestionId");

                    b.ToTable("tblCommitteeQuestionEvaluations","dbo");
                });

            modelBuilder.Entity("TrainDTrainorV2.Core.Data.Entities.Country", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Id")
            ...
            modelBuilder.Entity("TrainDTrainorV2.Core.Data.Entities.CourseMaterialPic", b =>
                {
                    ...
                    b.ToTable("CourseMaterialPicFiletable");
                });
            ...
            modelBuilder.Entity("TrainDTrainorV2.Core.Data.Entities.EvaluationVideoPic", b =>
                {
                    b.Property<Guid>("Stream_id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("EvaluationVideoPicFiletable");
                });
            ...
            modelBuilder.Entity("TrainDTrainorV2.Core.Data.Entities.LevelSubject", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Id")
                    ...
                    b.ToTable("tblLevelSubjects","dbo");
                });
            ...
            modelBuilder.Entity("TrainDTrainorV2.Core.Data.Entities.LevelVideoPic", b =>
                {
                    b.Property<Guid>("Stream_id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("LevelVideoPic_View","dbo");
                });
            ...
            modelBuilder.Entity("TrainDTrainorV2.Core.Data.Entities.PaymentTransactionHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Id")
                    ...
                    b.ToTable("tblPaymentTransactionHistory","dbo");
                });

            modelBuilder.Entity("TrainDTrainorV2.Core.Data.Entities.PaymentTransactionPic", b =>
                {
                    b.Property<Guid>("Stream_id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Stream_id")
                    ...
                    b.ToTable("PaymentTransactionPic_View","dbo");
                });
            ...
            modelBuilder.Entity("TrainDTrainorV2.Core.Data.Entities.TraineeExamResult", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Id")
                    ...
                    b.ToTable("tblTraineeExamResults","dbo");
                });
            ...
            modelBuilder.Entity("TrainDTrainorV2.Core.Data.Entities.TrainingBuildCourseAttendee", b =>
                {
                    ...
                    b.Property<Guid?>("TrainingBuildCourseParentId")
                    ...
                    b.HasIndex("TrainingBuildCourseParentId");
            ...
            modelBuilder.Entity("TrainDTrainorV2.Core.Data.Entities.TrainingExam", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Id")
                    ...
                    b.ToTable("tblTrainingExams","dbo");
                });

            modelBuilder.Entity("TrainDTrainorV2.Core.Data.Entities.TrainingExperience", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("tblUserProfileTrainingExperience","dbo");
                });
            ...
            modelBuilder.Entity("TrainDTrainorV2.Core.Data.Entities.TrainingVideoPic", b =>
                {
                    b.Property<Guid>("Stream_id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Stream_id")
                    ...
                    b.ToTable("TrainingVideoPic_View","dbo");
                });
            ...
            modelBuilder.Entity("TrainDTrainorV2.Core.Data.Entities.UserProfilePic", b =>
                {
                    ...
                    b.ToTable("UserProfilePic_View","dbo");
                });
            ...
            modelBuilder.Entity("TrainDTrainorV2.Core.Data.Entities.CommitteeQuestionEvaluation", b =>
                {
                    b.HasOne("TrainDTrainorV2.Core.Data.Entities.TrainingBuildCourseAttendee", "TrainingCourseAttendee")
                        .WithMany("CommitteeQuestionEvaluations")
                        .HasForeignKey("BuildCourseAttendeeId")
                        .HasConstraintName("FK_CommitteeQuestionEvaluations_TrainingCourseAttendee_BuildCourseAttendeeId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("TrainDTrainorV2.Core.Data.Entities.CommitteeQuestion", "CommitteeQuestion")
                        .WithMany("TraineeQuestionEvaluations")
                        .HasForeignKey("CommitteeQuestionId")
            ...
            modelBuilder.Entity("TrainDTrainorV2.Core.Data.Entities.PaymentTransactionHistory", b =>
                {
                    ...
                    b.HasOne("TrainDTrainorV2.Core.Data.Entities.PaymentTransaction", "PaymentTransaction")
                        .WithMany("PaymentTransactionHistories")
            ...
            modelBuilder.Entity("TrainDTrainorV2.Core.Data.Entities.TraineeExamResult", b =>
                {
                    ...
                    b.HasOne("TrainDTrainorV2.Core.Data.Entities.TrainingExam", "Question")
                        .WithMany("ExamResults")
            ...
            modelBuilder.Entity("TrainDTrainorV2.Core.Data.Entities.TrainingBuildCourseAttendee", b =>
                {
                    ...
                    b.HasOne("TrainDTrainorV2.Core.Data.Entities.TrainingBuildCourseAttendee", "TrainingCourseAttendee")
                        .WithMany("TrainingBuildCourseAttendees")
                        .HasForeignKey("TrainingBuildCourseParentId")
