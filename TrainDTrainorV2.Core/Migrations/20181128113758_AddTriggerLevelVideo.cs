...
{
    public partial class AddTriggerLevelVideo : Migration
    {
        private string TableName => "tbl"+typeof(LevelVideo).Name+"s";
        private string FileTableName => typeof(LevelVideoPic).Name;
