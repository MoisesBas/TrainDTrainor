...
namespace TrainDTrainorV2.Core.Data.Mapping
{
    ...
    public partial class PaymentTransactionPicMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<TrainDTrainorV2.Core.Data.Entities.PaymentTransactionPic>
    {
        public void Configure(EntityTypeBuilder<PaymentTransactionPic> builder)
        {
            builder.ToTable("PaymentTransactionPic_View", "dbo");
...
.HasColumnName("Id");
        ...
        partial void InitializeMapping(Microsoft.EntityFrameworkCore.Metadata.Builders.EntityTypeBuilder<TrainDTrainorV2.Core.Data.Entities.PaymentTransactionPic> builder);
