...
namespace TrainDTrainorV2.Core.Data.Mapping
{
    ...
    public partial class UserProfilePicMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<TrainDTrainorV2.Core.Data.Entities.UserProfilePic>
    {
        public void Configure(EntityTypeBuilder<UserProfilePic> builder)
        {
            builder.ToTable("UserProfilePic_View", "dbo");
...
.HasColumnName("Id");
        ...
        partial void InitializeMapping(Microsoft.EntityFrameworkCore.Metadata.Builders.EntityTypeBuilder<TrainDTrainorV2.Core.Data.Entities.UserProfilePic> builder);
