...
namespace TrainDTrainorV2.Core.Data.Mapping
{
    ...
    public partial class LevelVideoPicMap : Microsoft.EntityFrameworkCore.IEntityTypeConfiguration<TrainDTrainorV2.Core.Data.Entities.LevelVideoPic>
    {
        public void Configure(EntityTypeBuilder<LevelVideoPic> builder)
        {
            builder.ToTable("LevelVideoPic_View", "dbo");
...
.HasColumnName("Id");
           ...
           //builder.HasOne(x=>x.LevelVideo)
           //     .WithOne(x=>x.VideoPic)
           //     .HasForeignKey<LevelVideoPic>(d => d.Id)
           //     .HasConstraintName("FK_LevelVideo_VideoPic_Id");
            InitializeMapping(builder);
        }
        partial void InitializeMapping(Microsoft.EntityFrameworkCore.Metadata.Builders.EntityTypeBuilder<TrainDTrainorV2.Core.Data.Entities.LevelVideoPic> builder);
